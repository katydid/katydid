...
func TopsyturvyDescription() (desc *descriptor.FileDescriptorSet) {
	...
	}, {Name: func(v string) *string { return &v }("topsyturvy.proto"),
		Package:    func(v string) *string { return &v }("tests"),
		Dependency: []string{"github.com/gogo/protobuf/gogoproto/gogo.proto"},
		MessageType: []*descriptor.DescriptorProto{{Name: func(v string) *string { return &v }("TopsyTurvy"),
			Field: []*descriptor.FieldDescriptorProto{{Name: func(v string) *string { return &v }("Top"),
				Number:   func(v int32) *int32 { return &v }(1),
				Label:    func(v descriptor.FieldDescriptorProto_Label) *descriptor.FieldDescriptorProto_Label { return &v }(1),
				Type:     func(v descriptor.FieldDescriptorProto_Type) *descriptor.FieldDescriptorProto_Type { return &v }(11),
				TypeName: func(v string) *string { return &v }(".tests.Topsy"),
				JsonName: func(v string) *string { return &v }("top"),
			}, {Name: func(v string) *string { return &v }("Turf"),
				Number:   func(v int32) *int32 { return &v }(2),
				Label:    func(v descriptor.FieldDescriptorProto_Label) *descriptor.FieldDescriptorProto_Label { return &v }(1),
				Type:     func(v descriptor.FieldDescriptorProto_Type) *descriptor.FieldDescriptorProto_Type { return &v }(11),
				TypeName: func(v string) *string { return &v }(".tests.Turvy"),
				JsonName: func(v string) *string { return &v }("turf"),
			}},
			...
			Field: []*descriptor.FieldDescriptorProto{{Name: func(v string) *string { return &v }("Turf"),
				Number:   func(v int32) *int32 { return &v }(1),
				Label:    func(v descriptor.FieldDescriptorProto_Label) *descriptor.FieldDescriptorProto_Label { return &v }(1),
				Type:     func(v descriptor.FieldDescriptorProto_Type) *descriptor.FieldDescriptorProto_Type { return &v }(3),
				JsonName: func(v string) *string { return &v }("turf"),
			}, {Name: func(v string) *string { return &v }("Top"),
				Number:   func(v int32) *int32 { return &v }(2),
				Label:    func(v descriptor.FieldDescriptorProto_Label) *descriptor.FieldDescriptorProto_Label { return &v }(1),
				Type:     func(v descriptor.FieldDescriptorProto_Type) *descriptor.FieldDescriptorProto_Type { return &v }(3),
				JsonName: func(v string) *string { return &v }("top"),
