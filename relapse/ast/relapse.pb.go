...
type Grammar struct {
	TopPattern   *Pattern       `protobuf:"bytes,1,opt,name=TopPattern,json=topPattern" json:"TopPattern,omitempty"`
	PatternDecls []*PatternDecl `protobuf:"bytes,2,rep,name=PatternDecls,json=patternDecls" json:"PatternDecls,omitempty"`
	After        *Space         `protobuf:"bytes,3,opt,name=After,json=after" json:"After,omitempty"`
}
...
type PatternDecl struct {
	Hash    *Keyword `protobuf:"bytes,1,opt,name=Hash,json=hash" json:"Hash,omitempty"`
	Before  *Space   `protobuf:"bytes,2,opt,name=Before,json=before" json:"Before,omitempty"`
	Name    string   `protobuf:"bytes,3,opt,name=Name,json=name" json:"Name"`
	Eq      *Keyword `protobuf:"bytes,4,opt,name=Eq,json=eq" json:"Eq,omitempty"`
	Pattern *Pattern `protobuf:"bytes,5,opt,name=Pattern,json=pattern" json:"Pattern,omitempty"`
}
...
type Pattern struct {
	Empty      *Empty      `protobuf:"bytes,1,opt,name=Empty,json=empty" json:"Empty,omitempty"`
	TreeNode   *TreeNode   `protobuf:"bytes,3,opt,name=TreeNode,json=treeNode" json:"TreeNode,omitempty"`
	LeafNode   *LeafNode   `protobuf:"bytes,4,opt,name=LeafNode,json=leafNode" json:"LeafNode,omitempty"`
	Concat     *Concat     `protobuf:"bytes,5,opt,name=Concat,json=concat" json:"Concat,omitempty"`
	Or         *Or         `protobuf:"bytes,6,opt,name=Or,json=or" json:"Or,omitempty"`
	And        *And        `protobuf:"bytes,7,opt,name=And,json=and" json:"And,omitempty"`
	ZeroOrMore *ZeroOrMore `protobuf:"bytes,8,opt,name=ZeroOrMore,json=zeroOrMore" json:"ZeroOrMore,omitempty"`
	Reference  *Reference  `protobuf:"bytes,9,opt,name=Reference,json=reference" json:"Reference,omitempty"`
	Not        *Not        `protobuf:"bytes,10,opt,name=Not,json=not" json:"Not,omitempty"`
	ZAny       *ZAny       `protobuf:"bytes,11,opt,name=ZAny,json=zAny" json:"ZAny,omitempty"`
	Contains   *Contains   `protobuf:"bytes,12,opt,name=Contains,json=contains" json:"Contains,omitempty"`
	Optional   *Optional   `protobuf:"bytes,13,opt,name=Optional,json=optional" json:"Optional,omitempty"`
	Interleave *Interleave `protobuf:"bytes,14,opt,name=Interleave,json=interleave" json:"Interleave,omitempty"`
}
...
type Empty struct {
	Empty *Keyword `protobuf:"bytes,1,opt,name=Empty,json=empty" json:"Empty,omitempty"`
}
...
type TreeNode struct {
	Name    *NameExpr `protobuf:"bytes,1,opt,name=Name,json=name" json:"Name,omitempty"`
	Colon   *Keyword  `protobuf:"bytes,2,opt,name=Colon,json=colon" json:"Colon,omitempty"`
	Pattern *Pattern  `protobuf:"bytes,3,opt,name=Pattern,json=pattern" json:"Pattern,omitempty"`
}
...
type Contains struct {
	Dot     *Keyword `protobuf:"bytes,1,opt,name=Dot,json=dot" json:"Dot,omitempty"`
	Pattern *Pattern `protobuf:"bytes,2,opt,name=Pattern,json=pattern" json:"Pattern,omitempty"`
}
...
type LeafNode struct {
	Expr *Expr `protobuf:"bytes,1,opt,name=Expr,json=expr" json:"Expr,omitempty"`
}
...
type Concat struct {
	OpenBracket  *Keyword `protobuf:"bytes,2,opt,name=OpenBracket,json=openBracket" json:"OpenBracket,omitempty"`
	LeftPattern  *Pattern `protobuf:"bytes,3,opt,name=LeftPattern,json=leftPattern" json:"LeftPattern,omitempty"`
	Comma        *Keyword `protobuf:"bytes,4,opt,name=Comma,json=comma" json:"Comma,omitempty"`
	RightPattern *Pattern `protobuf:"bytes,5,opt,name=RightPattern,json=rightPattern" json:"RightPattern,omitempty"`
	ExtraComma   *Keyword `protobuf:"bytes,6,opt,name=ExtraComma,json=extraComma" json:"ExtraComma,omitempty"`
	CloseBracket *Keyword `protobuf:"bytes,7,opt,name=CloseBracket,json=closeBracket" json:"CloseBracket,omitempty"`
}
...
type Or struct {
	OpenParen    *Keyword `protobuf:"bytes,1,opt,name=OpenParen,json=openParen" json:"OpenParen,omitempty"`
	LeftPattern  *Pattern `protobuf:"bytes,2,opt,name=LeftPattern,json=leftPattern" json:"LeftPattern,omitempty"`
	Pipe         *Keyword `protobuf:"bytes,3,opt,name=Pipe,json=pipe" json:"Pipe,omitempty"`
	RightPattern *Pattern `protobuf:"bytes,4,opt,name=RightPattern,json=rightPattern" json:"RightPattern,omitempty"`
	CloseParen   *Keyword `protobuf:"bytes,5,opt,name=CloseParen,json=closeParen" json:"CloseParen,omitempty"`
}
...
type And struct {
	OpenParen    *Keyword `protobuf:"bytes,1,opt,name=OpenParen,json=openParen" json:"OpenParen,omitempty"`
	LeftPattern  *Pattern `protobuf:"bytes,2,opt,name=LeftPattern,json=leftPattern" json:"LeftPattern,omitempty"`
	Ampersand    *Keyword `protobuf:"bytes,3,opt,name=Ampersand,json=ampersand" json:"Ampersand,omitempty"`
	RightPattern *Pattern `protobuf:"bytes,4,opt,name=RightPattern,json=rightPattern" json:"RightPattern,omitempty"`
	CloseParen   *Keyword `protobuf:"bytes,5,opt,name=CloseParen,json=closeParen" json:"CloseParen,omitempty"`
}
...
type ZeroOrMore struct {
	OpenParen  *Keyword `protobuf:"bytes,1,opt,name=OpenParen,json=openParen" json:"OpenParen,omitempty"`
	Pattern    *Pattern `protobuf:"bytes,2,opt,name=Pattern,json=pattern" json:"Pattern,omitempty"`
	CloseParen *Keyword `protobuf:"bytes,3,opt,name=CloseParen,json=closeParen" json:"CloseParen,omitempty"`
	Star       *Keyword `protobuf:"bytes,4,opt,name=Star,json=star" json:"Star,omitempty"`
}
...
type Reference struct {
	At   *Keyword `protobuf:"bytes,1,opt,name=At,json=at" json:"At,omitempty"`
...
type Not struct {
	Exclamation *Keyword `protobuf:"bytes,1,opt,name=Exclamation,json=exclamation" json:"Exclamation,omitempty"`
	OpenParen   *Keyword `protobuf:"bytes,2,opt,name=OpenParen,json=openParen" json:"OpenParen,omitempty"`
	Pattern     *Pattern `protobuf:"bytes,3,opt,name=Pattern,json=pattern" json:"Pattern,omitempty"`
	CloseParen  *Keyword `protobuf:"bytes,4,opt,name=CloseParen,json=closeParen" json:"CloseParen,omitempty"`
}
...
type ZAny struct {
	Star *Keyword `protobuf:"bytes,1,opt,name=Star,json=star" json:"Star,omitempty"`
}
...
type Optional struct {
	...
	Pattern      *Pattern `protobuf:"bytes,2,opt,name=Pattern,json=pattern" json:"Pattern,omitempty"`
	CloseParen   *Keyword `protobuf:"bytes,3,opt,name=CloseParen,json=closeParen" json:"CloseParen,omitempty"`
	QuestionMark *Keyword `protobuf:"bytes,4,opt,name=QuestionMark,json=questionMark" json:"QuestionMark,omitempty"`
}
...
type Interleave struct {
	OpenCurly      *Keyword `protobuf:"bytes,2,opt,name=OpenCurly,json=openCurly" json:"OpenCurly,omitempty"`
	LeftPattern    *Pattern `protobuf:"bytes,3,opt,name=LeftPattern,json=leftPattern" json:"LeftPattern,omitempty"`
	SemiColon      *Keyword `protobuf:"bytes,4,opt,name=SemiColon,json=semiColon" json:"SemiColon,omitempty"`
	RightPattern   *Pattern `protobuf:"bytes,5,opt,name=RightPattern,json=rightPattern" json:"RightPattern,omitempty"`
	ExtraSemiColon *Keyword `protobuf:"bytes,6,opt,name=ExtraSemiColon,json=extraSemiColon" json:"ExtraSemiColon,omitempty"`
	CloseCurly     *Keyword `protobuf:"bytes,7,opt,name=CloseCurly,json=closeCurly" json:"CloseCurly,omitempty"`
}
...
type Expr struct {
	RightArrow *Keyword  `protobuf:"bytes,1,opt,name=RightArrow,json=rightArrow" json:"RightArrow,omitempty"`
	Comma      *Keyword  `protobuf:"bytes,2,opt,name=Comma,json=comma" json:"Comma,omitempty"`
	Terminal   *Terminal `protobuf:"bytes,3,opt,name=Terminal,json=terminal" json:"Terminal,omitempty"`
	List       *List     `protobuf:"bytes,4,opt,name=List,json=list" json:"List,omitempty"`
	Function   *Function `protobuf:"bytes,5,opt,name=Function,json=function" json:"Function,omitempty"`
	BuiltIn    *BuiltIn  `protobuf:"bytes,6,opt,name=BuiltIn,json=builtIn" json:"BuiltIn,omitempty"`
}
...
type List struct {
	Before     *Space     `protobuf:"bytes,1,opt,name=Before,json=before" json:"Before,omitempty"`
	Type       types.Type `protobuf:"varint,2,opt,name=Type,json=type,enum=types.Type" json:"Type"`
	OpenCurly  *Keyword   `protobuf:"bytes,3,opt,name=OpenCurly,json=openCurly" json:"OpenCurly,omitempty"`
	Elems      []*Expr    `protobuf:"bytes,4,rep,name=Elems,json=elems" json:"Elems,omitempty"`
	CloseCurly *Keyword   `protobuf:"bytes,5,opt,name=CloseCurly,json=closeCurly" json:"CloseCurly,omitempty"`
}
...
type Function struct {
	Before     *Space   `protobuf:"bytes,1,opt,name=Before,json=before" json:"Before,omitempty"`
	Name       string   `protobuf:"bytes,2,opt,name=Name,json=name" json:"Name"`
	OpenParen  *Keyword `protobuf:"bytes,3,opt,name=OpenParen,json=openParen" json:"OpenParen,omitempty"`
	Params     []*Expr  `protobuf:"bytes,4,rep,name=Params,json=params" json:"Params,omitempty"`
	CloseParen *Keyword `protobuf:"bytes,5,opt,name=CloseParen,json=closeParen" json:"CloseParen,omitempty"`
}
...
type BuiltIn struct {
	Symbol *Keyword `protobuf:"bytes,1,opt,name=Symbol,json=symbol" json:"Symbol,omitempty"`
	Expr   *Expr    `protobuf:"bytes,2,opt,name=Expr,json=expr" json:"Expr,omitempty"`
}
...
type Terminal struct {
	Before      *Space    `protobuf:"bytes,1,opt,name=Before,json=before" json:"Before,omitempty"`
	Literal     string    `protobuf:"bytes,2,opt,name=Literal,json=literal" json:"Literal"`
	DoubleValue *float64  `protobuf:"fixed64,3,opt,name=DoubleValue,json=doubleValue" json:"DoubleValue,omitempty"`
	IntValue    *int64    `protobuf:"varint,5,opt,name=IntValue,json=intValue" json:"IntValue,omitempty"`
	UintValue   *uint64   `protobuf:"varint,6,opt,name=UintValue,json=uintValue" json:"UintValue,omitempty"`
	BoolValue   *bool     `protobuf:"varint,8,opt,name=BoolValue,json=boolValue" json:"BoolValue,omitempty"`
	StringValue *string   `protobuf:"bytes,9,opt,name=StringValue,json=stringValue" json:"StringValue,omitempty"`
	BytesValue  []byte    `protobuf:"bytes,10,opt,name=BytesValue,json=bytesValue" json:"BytesValue,omitempty"`
	Variable    *Variable `protobuf:"bytes,50,opt,name=Variable,json=variable" json:"Variable,omitempty"`
}
...
type Space struct {
	Space []string `protobuf:"bytes,1,rep,name=Space,json=space" json:"Space,omitempty"`
}
...
type NameExpr struct {
	Name          *Name          `protobuf:"bytes,1,opt,name=Name,json=name" json:"Name,omitempty"`
	AnyName       *AnyName       `protobuf:"bytes,2,opt,name=AnyName,json=anyName" json:"AnyName,omitempty"`
	AnyNameExcept *AnyNameExcept `protobuf:"bytes,3,opt,name=AnyNameExcept,json=anyNameExcept" json:"AnyNameExcept,omitempty"`
	NameChoice    *NameChoice    `protobuf:"bytes,4,opt,name=NameChoice,json=nameChoice" json:"NameChoice,omitempty"`
}
...
type AnyName struct {
	Underscore *Keyword `protobuf:"bytes,1,opt,name=Underscore,json=underscore" json:"Underscore,omitempty"`
}
...
type AnyNameExcept struct {
	Exclamation *Keyword  `protobuf:"bytes,1,opt,name=Exclamation,json=exclamation" json:"Exclamation,omitempty"`
	OpenParen   *Keyword  `protobuf:"bytes,2,opt,name=OpenParen,json=openParen" json:"OpenParen,omitempty"`
	Except      *NameExpr `protobuf:"bytes,3,opt,name=Except,json=except" json:"Except,omitempty"`
	CloseParen  *Keyword  `protobuf:"bytes,4,opt,name=CloseParen,json=closeParen" json:"CloseParen,omitempty"`
}
...
type NameChoice struct {
	OpenParen  *Keyword  `protobuf:"bytes,1,opt,name=OpenParen,json=openParen" json:"OpenParen,omitempty"`
	Left       *NameExpr `protobuf:"bytes,2,opt,name=Left,json=left" json:"Left,omitempty"`
	Pipe       *Keyword  `protobuf:"bytes,3,opt,name=Pipe,json=pipe" json:"Pipe,omitempty"`
	Right      *NameExpr `protobuf:"bytes,4,opt,name=Right,json=right" json:"Right,omitempty"`
	CloseParen *Keyword  `protobuf:"bytes,5,opt,name=CloseParen,json=closeParen" json:"CloseParen,omitempty"`
}
...
var fileDescriptorRelapse = []byte{
	...
	,
}
