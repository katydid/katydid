...
var menuPaperClip = G{
	"main": InOrder(
		...
		In("PocketRoses",
			Any(),
			In("MenuPaperclip", Value(Contains(StringVar(), StringConst("a")))),
			Any(),
		),
		Any(),
	),
	...
	"main": InOrder(
		...
		In("FinanceJudo",
			...
			In("SaladWorry",
				...
				In("SpyCarpenter",
					Any(),
					In("BridgePepper", Value(Contains(StringVar(), StringConst("a")))),
					Any(),
				),
				Any(),
			),
	...
	"main": InOrder(
		...
		In("FinanceJudo",
			...
			In("SaladWorry",
				...
				In("SpyCarpenter",
					AllOf(
						InPath("BridgePepper", Value(Contains(StringVar(), StringConst("a")))),
						InPath("FountainTarget", Value(Contains(StringVar(), StringConst("a")))),
					),
				),
				Any(),
			),
