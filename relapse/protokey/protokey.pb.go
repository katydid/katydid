...
func init() {
	proto.RegisterType((*ProtoKey)(nil), "protokey.ProtoKey")
	proto.RegisterType((*KeyValue)(nil), "protokey.KeyValue")
	proto.RegisterType((*TopsyTurvy)(nil), "protokey.TopsyTurvy")
	proto.RegisterType((*Topsy)(nil), "protokey.Topsy")
	proto.RegisterType((*Turvy)(nil), "protokey.Turvy")
	proto.RegisterType((*Knot)(nil), "protokey.Knot")
	proto.RegisterType((*BightKnot)(nil), "protokey.BightKnot")
}
func (this *ProtoKey) Description() (desc *descriptor.FileDescriptorSet) {
...
func ProtokeyDescription() (desc *descriptor.FileDescriptorSet) {
	...
	}, {Name: func(v string) *string { return &v }("protokey.proto"),
		Package:    func(v string) *string { return &v }("protokey"),
		Dependency: []string{"github.com/gogo/protobuf/gogoproto/gogo.proto"},
		MessageType: []*descriptor.DescriptorProto{{Name: func(v string) *string { return &v }("ProtoKey"),
			Field: []*descriptor.FieldDescriptorProto{{Name: func(v string) *string { return &v }("KeyValue"),
				Number:   func(v int32) *int32 { return &v }(2),
				Label:    func(v descriptor.FieldDescriptorProto_Label) *descriptor.FieldDescriptorProto_Label { return &v }(3),
				Type:     func(v descriptor.FieldDescriptorProto_Type) *descriptor.FieldDescriptorProto_Type { return &v }(11),
				TypeName: func(v string) *string { return &v }(".protokey.KeyValue"),
			}},
			...
			Field: []*descriptor.FieldDescriptorProto{{Name: func(v string) *string { return &v }("Topsy"),
				...
				Label:    func(v descriptor.FieldDescriptorProto_Label) *descriptor.FieldDescriptorProto_Label { return &v }(1),
				Type:     func(v descriptor.FieldDescriptorProto_Type) *descriptor.FieldDescriptorProto_Type { return &v }(11),
				TypeName: func(v string) *string { return &v }(".protokey.Topsy"),
			}, {Name: func(v string) *string { return &v }("Turvy"),
				Number:   func(v int32) *int32 { return &v }(2),
				Label:    func(v descriptor.FieldDescriptorProto_Label) *descriptor.FieldDescriptorProto_Label { return &v }(1),
				Type:     func(v descriptor.FieldDescriptorProto_Type) *descriptor.FieldDescriptorProto_Type { return &v }(11),
				TypeName: func(v string) *string { return &v }(".protokey.Turvy"),
			}},
			...
			Field: []*descriptor.FieldDescriptorProto{{Name: func(v string) *string { return &v }("Bight"),
				...
				Label:    func(v descriptor.FieldDescriptorProto_Label) *descriptor.FieldDescriptorProto_Label { return &v }(3),
				Type:     func(v descriptor.FieldDescriptorProto_Type) *descriptor.FieldDescriptorProto_Type { return &v }(11),
				TypeName: func(v string) *string { return &v }(".protokey.BightKnot"),
				...
				Label:    func(v descriptor.FieldDescriptorProto_Label) *descriptor.FieldDescriptorProto_Label { return &v }(1),
				Type:     func(v descriptor.FieldDescriptorProto_Type) *descriptor.FieldDescriptorProto_Type { return &v }(11),
				TypeName: func(v string) *string { return &v }(".protokey.Knot"),
			}},
...
func (this *KeyValue) GoString() string {
	...
	s := make([]string, 0, 6)
	s = append(s, "&protokey.KeyValue{")
	if this.Key != nil {
		s = append(s, "Key: "+valueToGoStringProtokey(this.Key, "string")+",\n")
	}
	if this.Value != nil {
		s = append(s, "Value: "+valueToGoStringProtokey(this.Value, "string")+",\n")
	}
	if this.XXX_unrecognized != nil {
		s = append(s, "XXX_unrecognized:"+fmt.Sprintf("%#v", this.XXX_unrecognized)+",\n")
	}
...
func (this *TopsyTurvy) GoString() string {
	...
	s := make([]string, 0, 6)
	s = append(s, "&protokey.TopsyTurvy{")
	if this.Topsy != nil {
...
func (this *Topsy) GoString() string {
	...
	s := make([]string, 0, 6)
	s = append(s, "&protokey.Topsy{")
	if this.A != nil {
		s = append(s, "A: "+valueToGoStringProtokey(this.A, "int64")+",\n")
	}
	if this.B != nil {
		s = append(s, "B: "+valueToGoStringProtokey(this.B, "int64")+",\n")
	}
	if this.XXX_unrecognized != nil {
		s = append(s, "XXX_unrecognized:"+fmt.Sprintf("%#v", this.XXX_unrecognized)+",\n")
	}
...
func (this *Knot) GoString() string {
	...
	s := make([]string, 0, 7)
	s = append(s, "&protokey.Knot{")
	if this.Bight != nil {
		s = append(s, "Bight: "+fmt.Sprintf("%#v", this.Bight)+",\n")
	}
	if this.Elbow != nil {
		s = append(s, "Elbow: "+valueToGoStringProtokey(this.Elbow, "bool")+",\n")
	}
...
func (this *BightKnot) GoString() string {
	...
	s := make([]string, 0, 6)
	s = append(s, "&protokey.BightKnot{")
	if this.Loop != nil {
		s = append(s, "Loop: "+fmt.Sprintf("%#v", this.Loop)+",\n")
	}
	if this.Turn != nil {
		s = append(s, "Turn: "+valueToGoStringProtokey(this.Turn, "bool")+",\n")
	}
	if this.XXX_unrecognized != nil {
		s = append(s, "XXX_unrecognized:"+fmt.Sprintf("%#v", this.XXX_unrecognized)+",\n")
	}
