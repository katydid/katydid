...
func (m *NameExpr) MarshalTo(data []byte) (int, error) {
	...
	if m.AnyName != nil {
		...
		n18, err := m.AnyName.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n18
	...
	if m.AnyNameExcept != nil {
		...
		n19, err := m.AnyNameExcept.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n19
	...
	if m.NameChoice != nil {
		...
		n20, err := m.NameChoice.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n20
...
func (m *AnyName) MarshalTo(data []byte) (int, error) {
	...
	if m.Underscore != nil {
		...
		n22, err := m.Underscore.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n22
...
func (m *AnyNameExcept) MarshalTo(data []byte) (int, error) {
	...
	if m.Exclamation != nil {
		...
		n23, err := m.Exclamation.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n23
	...
	if m.OpenParen != nil {
		...
		i++
		i = encodeVarintExpr(data, i, uint64(m.OpenParen.Size()))
		n24, err := m.OpenParen.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n24
	...
	if m.Except != nil {
		...
		n25, err := m.Except.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n25
...
func (m *NameChoice) MarshalTo(data []byte) (int, error) {
	...
	if m.OpenParen != nil {
		...
		i++
		i = encodeVarintExpr(data, i, uint64(m.OpenParen.Size()))
		n27, err := m.OpenParen.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n27
	...
	if m.Left != nil {
		...
		n28, err := m.Left.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n28
	...
	if m.Pipe != nil {
		...
		n29, err := m.Pipe.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n29
	...
	if m.Right != nil {
		...
		n30, err := m.Right.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n30
	...
	if m.CloseParen != nil {
		...
		i++
		i = encodeVarintExpr(data, i, uint64(m.CloseParen.Size()))
		n31, err := m.CloseParen.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n31
